...
export const getGetAdminUserBorrowersUrl = (id: number,) => {




  return `/api/admin/users/${id}/borrowers`
}

/**
 * @summary Admin - list active borrowers for a specific lender user
 */
export const getAdminUserBorrowers = async (id: number, options?: RequestInit): Promise<AdminUserBorrower[]> => {

  return customFetch<AdminUserBorrower[]>(getGetAdminUserBorrowersUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetAdminUserBorrowersQueryKey = (id: number,) => {
    return [
    `/api/admin/users/${id}/borrowers`
    ] as const;
    }


export const getGetAdminUserBorrowersQueryOptions = <TData = Awaited<ReturnType<typeof getAdminUserBorrowers>>, TError = ErrorType<void>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAdminUserBorrowers>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetAdminUserBorrowersQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAdminUserBorrowers>>> = ({ signal }) => getAdminUserBorrowers(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(id), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAdminUserBorrowers>>, TError, TData> & { queryKey: QueryKey }
}

export type GetAdminUserBorrowersQueryResult = NonNullable<Awaited<ReturnType<typeof getAdminUserBorrowers>>>
export type GetAdminUserBorrowersQueryError = ErrorType<void>
...
export function useGetAdminUserBorrowers<TData = Awaited<ReturnType<typeof getAdminUserBorrowers>>, TError = ErrorType<void>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAdminUserBorrowers>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetAdminUserBorrowersQueryOptions(id,options)
